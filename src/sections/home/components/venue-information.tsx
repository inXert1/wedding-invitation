              ...
              <div className="space-y-6">
                ...
                <div className="bg-snow/50 rounded-2xl p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-center">
                    <p className="w-full bg-amethyst border border-amethyst/30 text-snow py-3 px-6 rounded-xl font-medium hover:bg-beige-light transition-all duration-300 shadow-lg hover:shadow-xl text-sm uppercase text-center text-sm sm:text-base cursor-pointer font-dm-sans">
                      {t('venue.promissory')}
                    </p>
                  </div>
                </div>
